            ...
            <>
                ...
                <div className="about">    
                    <div>
                        ...
                        <img src={require('../images/about_1.webp')} alt="Tregye Foundation Art & Design Annual Summer Show 2020"></img>
                    </div>
                    <div>
                        <img src={require('../images/about_2.webp')} alt="Georgina Bazin selfie"></img>
